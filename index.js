  ...
  return (
    <>
      ...
      <div className=" md:flex-col flex-col-reverse lg:flex-row flex-wrap  py-18 bg-graylight-1 flex  w-full text-right  ">
        ...
        <div className="bg-primary lg:w-6/12 md:flex-row flex-col flex  relative   ">
          <img
            className="shadow-3xl  w-5/12  md:w-4/12 absolute md:top-28 lg:top-10 top-8 left-40 md:left-100 lg:-left-4"
            src='/img/story-2.jpeg'
            alt="Picture" />
          <div className='md:py-16 px-16 md:pb-16  ' >

            <img
              className="md:w-9/12   shadow-3xl   mx-auto"
        ...
        <div className="flex  bg-white mb-8  justify-space-evenly  flex-wrap   py-8   ">
